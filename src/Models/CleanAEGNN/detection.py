...
#import pytorch_lightning as pl I don't think this will damage anything if missing
from ..base import BaseModel
from .GraphRes import GraphRes as AEGNN
...
class DetectionModel(BaseModel):
    def __init__(self, num_classes: int, img_shape: Tuple[int, int], dim: int = 3,
                 num_bounding_boxes: int = 1, device = "cpu"):
        ...
        self.model = AEGNN(model_input_shape,
        kernel_size = 8,
