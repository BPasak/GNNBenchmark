...
def reset_bn(
    ...
    from datasets.detector.efvit.utils import AverageMeter, is_master, sync_tensor
    from datasets.detector.efvit.utils import get_device, list_join
...
def set_norm_eps(model: nn.Module, eps: Union[float, None] = None) -> None:
